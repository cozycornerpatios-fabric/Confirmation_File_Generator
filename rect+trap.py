        ...
        for cushion in cushions:
            ...
            if ties.lower() != "none":
                ...
                if ties == "2 Side Short" or ties=="2 Side":
                    ...
                    label_x = x_origin + horizontal_side + piping_margin + 0.1 * inch + 40
                    label_y = (y_origin + vertical_side)/2 ;
                    draw_tie(label_x, label_y, 'down', 'vertical')
                    c.drawRightString(label_x + 20, label_y, "Ties")
...
@app.route('/')
def index():
    return render_template_string(open("r+t.html").read())
